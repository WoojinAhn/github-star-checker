...
GitHub Actions 워크플로우로 소유한 공개(public) 레포지토리의 스타 수를 모니터링하고, 스타 변화(증가/감소)가 감지되면 Gmail로 이메일 알림을 보냅니다. Private 및 Fork 레포는 제외됩니다.
...
4. 스타 변화(증가/감소)가 있는 레포 목록을 Gmail SMTP로 이메일 발송
